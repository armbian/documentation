...
An **experimental upgrade option** is available in [armbian-config](https://docs.armbian.com/config/updates/#stable-distro-upgrade), but it is provided *as-is* and without support.
