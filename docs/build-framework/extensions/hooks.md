...
- To regenerate it from a build tree, run [`./compile.sh show-extensions SHOW_EXTENSIONS=docs`](/build-framework/commands/advanced/#show-extensions). That also lists hooks added by your own userpatches, which this page does not cover.

## Hooks

- Hooks are listed in the order they are called.
- Individual/specific hook functions can be [skipped/ignored/opted-out](/build-framework/extensions/#how-to-opt-out-of-a-specific-hook-function).
