...
- To regenerate it from a build tree, run [`./compile.sh show-extensions SHOW_EXTENSIONS=docs`](Developer-Guide_Build-Commands.md#show-extensions). That also lists hooks added by your own userpatches, which this page does not cover.
