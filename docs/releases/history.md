---
title: Armbian release history
description: "Archived Armbian release notes for every version before 25.x, from v1.0 in 2013 through v24.11.1, preserved from the original Armbian changelog."
---

# Armbian release history

Release notes for Armbian versions before 25.x, archived from the original changelog. Notes for 25.x and later live on their own pages, listed on the [releases index](index.md).
