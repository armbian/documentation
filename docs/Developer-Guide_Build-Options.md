...
- **RELEASE** ( `stretch` | `buster` | `bullseye` | `bionic` | `focal` | `groovy` | `hirsute` ): set OS release manually to skip dialog prompt; use this option with `KERNEL_ONLY=yes` to create board support package  
