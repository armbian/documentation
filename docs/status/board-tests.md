...
??? success "SpacemiT K3 Pico-ITX 01 — pass"
    ...
    | Module | Status | Time | Detail |
    |:--|:--:|--:|:--|
    | upgrade | ✅ | 47.6 s | nightly · 26.11.0-trunk.49 → 26.11.0-trunk.49 |
    | reboot | ✅ | 67.1 s | power-cycle · up 30 s |
    | hw-performance | ✅ | 12.1 s | AES 778 · mem 12500 · disk W 1392 / R 1548 MB/s · 47 °C · 2150 MHz |
    | dvfs | ✅ | 14.2 s | performance · 614–2150 MHz (peak 2150) |
    | network-iperf | ✅ | 26.8 s | eth0 ↑939/↓939 (1GE) Mbps |
    | restore-stable | ✅ | 37.2 s | stable |
    | reboot | ✅ | 54.0 s | power-cycle · up 33 s |
