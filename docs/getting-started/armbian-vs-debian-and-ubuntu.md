...
| Primary target | Servers, desktops, x86 & official ARM ports | Cloud, desktop, x86 & certified ARM | **SBCs first** &mdash; [~400 ARM/RISC-V boards](https://www.armbian.com/download/) &mdash; plus cloud UEFI x86-64/arm64 |
