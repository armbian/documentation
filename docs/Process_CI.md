...
**Note**: you can only generate images that are defined in `targets-release-standard-support.yaml` build lists!
...
**Note:** you can only generate images for applications that are defined in `targets-release-apps.yaml` build lists!
...
Generated images are hosted at GitHub and released at once. Automation refreshes download pages within 15-30 minutes after builds finished succesfully.
